...
Finally, Figures \ref{fig:powercurvemarkov1}, \ref{fig:powercurvemarkov2} and \ref{fig:powercurvemarkov3} exhibit power curves for the Markovian model. It is possible to visulise, again, a considerable negative influence of the dimension $d$ on the test power.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{plots/power_markov1.pdf}
    \caption{Empirical power as a function of the significance level in the model ``Markovian process'', for $n=100$, $d=1$ and $r=2$; the parameter $\kappa \in [0,\infty)$ represents deviation from independence, and $c = -1, 0, 1$ is a tuning parameter related to the degree of smoothness (see the text in this section). Axes in log-scale.} 
    \label{fig:powercurvemarkov1}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{plots/power_markov2.pdf}
    \caption{Same description as in Figure \ref{fig:powercurve1}, but with $d=10$ and $r=2$.} 
    \label{fig:powercurvemarkov2}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{plots/power_markov3.pdf}
    \caption{Same description as in Figure \ref{fig:powercurve1}, but with $d=1$ and $r=10$.} 
    \label{fig:powercurvemarkov3}
\end{figure}
